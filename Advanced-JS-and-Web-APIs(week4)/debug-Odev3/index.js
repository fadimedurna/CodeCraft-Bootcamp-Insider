...
class ShoppingCart {
  ...
  addItem(productId, quantity = 1) {
    try {
      ...
      //SORUN1: Sepete ürün eklenince stok azalmıyor(çözüm)
  ...
  showError(message) {
    ...
    if (errorElement) {
      errorElement.textContent = message; // += yerine = kullan
